      ...
      {[
        {
          ...
          location: "Mumbai",
          rating: 5,
          text: "Novasun Solar transformed our home! We've seen 95% reduction in electricity bills and the installation was seamless."
        },
        {
          name: "Priya Sharma",
          location: "Delhi",
          rating: 5,
          text: "Excellent service and quality. The team was professional and the system has been working perfectly for 2 years now."
        },
        {
          name: "Vikram Industries",
          location: "Pune",
          rating: 5,
          text: "Our commercial installation has exceeded expectations. Great ROI and outstanding after-sales support."
        }
  ...
  <div className="container mx-auto px-4 relative z-10">
    ...
    >
      ...
      <motion.div 
        ...
        whileHover={{ scale: 1.05, rotateY: 5 }}
        className={`flex flex-col items-center p-6 rounded-2xl backdrop-blur-sm border transition-all duration-300 ${
          theme === 'dark'
            ? 'bg-gradient-to-br from-[#2f4ecc]/20 to-gray-800/20 border-white/10 hover:border-yellow-400/30 hover:bg-[#2f4ecc]/30'
      ...
      >
        ...
        <motion.p 
          ...
          className="text-gray-400 hover:text-yellow-400 transition-colors cursor-pointer"
        >
          info@novasunsolar.com
        </motion.p>
        <motion.p 
          whileHover={{ color: '#fbbf24' }}
          className="text-gray-400 text-xs hover:text-yellow-400 transition-colors cursor-pointer"
        >
          jayantk735@gmail.com
        </motion.p>
      </motion.div>
      ...
      >
        ...
        <h3 className="font-semibold mb-1 text-white">Visit Us</h3>
        <motion.p 
          whileHover={{ color: '#fbbf24' }}
          className="text-gray-400 text-center text-sm hover:text-yellow-400 transition-colors cursor-pointer leading-relaxed"
        >
          Plot no. 4, Ganapati Vihar, Khargapur, Gomti Nagar Ext., Lucknow-226010
        </motion.p>
      </motion.div>
      ...
      >
        ...
        <h3 className="font-semibold mb-1 text-white">Company Info</h3>
        <motion.p 
          whileHover={{ color: '#fbbf24' }}
          className="text-gray-400 text-xs text-center hover:text-yellow-400 transition-colors cursor-pointer"
        >
          CIN: U70101GJ2015PTC083121
        </motion.p>
        <motion.p 
          whileHover={{ color: '#fbbf24' }}
          className="text-gray-400 text-xs text-center hover:text-yellow-400 transition-colors cursor-pointer leading-relaxed"
        >
          A unit of Soil and Brick Infraventures Pvt Ltd
        </motion.p>
      </motion.div>
    </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-400">+91 8866055333</p>
              <p className="text-gray-400">+91 8318493980</p>
            </div>
            <div className="flex flex-col items-center">
              <Mail className="w-8 h-8 text-yellow-400 mb-2" />
              <h3 className="font-semibold mb-1">Email Us</h3>
              <p className="text-gray-400">info@novasunsolar.com</p>
              <p className="text-gray-400 text-xs">jayantk735@gmail.com</p>
            </div>
            <div className="flex flex-col items-center">
              <MapPin className="w-8 h-8 text-yellow-400 mb-2" />
              <h3 className="font-semibold mb-1">Visit Us</h3>
              <p className="text-gray-400 text-center text-sm">Plot no. 4, Ganapati Vihar, Khargapur, Gomti Nagar Ext., Lucknow-226010</p>
            </div>
            <div className="flex flex-col items-center">
              <Building className="w-8 h-8 text-yellow-400 mb-2" />
              <h3 className="font-semibold mb-1">Company Info</h3>
              <p className="text-gray-400 text-xs text-center">CIN: U70101GJ2015PTC083121</p>
              <p className="text-gray-400 text-xs text-center">A unit of Soil and Brick Infraventures Pvt Ltd</p>
            </div>
          </div>
        </div>
      </section>
