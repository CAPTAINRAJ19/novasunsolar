          ...
          <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className={`${theme === 'dark' ? 'text-gray-200' : 'text-gray-700'} text-lg leading-relaxed`}>
                Our mission is to harness the infinite power of the sun to create sustainable, accessible energy solutions for every home and business. By empowering communities with clean energy technology and reducing carbon emissions, we pave the way to a cleaner, brighter, and more sustainable future for generations to come.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className={`${theme === 'dark' ? 'text-gray-200' : 'text-gray-700'} text-lg leading-relaxed`}>
                We envision a world where renewable energy is the cornerstone of every community. Through innovative solar solutions, we aim to revolutionize India's energy landscape, creating prosperous communities, driving sustainable profitability, and fostering environmental stewardship while building lasting trust with every client we serve.
              </p>
            </motion.div>
          </div>
        </section>
              ...
              {values.map((val, i) => (
                ...
                >
                  <motion.div 
                    ...
                    className="mb-6"
                  >
                    <val.icon className={`w-16 h-16 ${val.color} group-hover:scale-110 transition-all duration-300`} />
                  </motion.div>
